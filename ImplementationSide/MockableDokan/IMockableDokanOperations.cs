...
namespace TestableDokan.MockableDokan
{
    ...
    public interface IMockableDokanOperations
    {
        /// <summary>
        ...
        /// can be opened and <see cref="IDokanFileInfoWrapper.IsDirectory"/> has to be set to <c>true</c>.
        /// On the other hand, if <see cref="IDokanFileInfoWrapper.IsDirectory"/> is set to <c>true</c>
        /// but the path target a file, you need to return <see cref="NtStatus.NotADirectory"/>
        /// 
        /// <see cref="IDokanFileInfoWrapper.Context"/> can be used to store data (like <c><see cref="FileStream"/></c>)
        ...
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        ...
        /// </summary>
        /// <remarks>
        /// When <see cref="IDokanFileInfoWrapper.DeleteOnClose"/> is <c>true</c>, you must delete the file in Cleanup.
        ...
        void Cleanup(string fileName, IDokanFileInfoWrapper info);
        ...
        /// 
        /// Remainings in <see cref="IDokanFileInfoWrapper.Context"/> has to be cleared before return.
        /// </summary>
        /// <param name="fileName">File path requested by the Kernel on the FileSystem.</param>
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <seealso cref="Cleanup"/>
        void CloseFile(string fileName, IDokanFileInfoWrapper info);
        ...
        NtStatus ReadFile(string fileName, byte[] buffer, out int bytesRead, long offset, IDokanFileInfoWrapper info);
        ...
        NtStatus WriteFile(string fileName, byte[] buffer, out int bytesWritten, long offset, IDokanFileInfoWrapper info);
        ...
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        NtStatus FlushFileBuffers(string fileName, IDokanFileInfoWrapper info);

        /// <summary>
        /// Get specific informations on a file.
        /// </summary>
        /// <param name="fileName">File path requested by the Kernel on the FileSystem.</param>
        /// <param name="fileInfo"><see cref="DokanNet.FileInformation"/> struct to fill</param>
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        NtStatus GetFileInformation(string fileName, out DokanNet.FileInformation fileInfo, IDokanFileInfoWrapper info);
        ...
        /// </summary>
        /// <param name="fileName">File path requested by the Kernel on the FileSystem.</param>
        /// <param name="files">A list of <see cref="DokanNet.FileInformation"/> to return.</param>
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        /// <seealso cref="FindFilesWithPattern"/>
        NtStatus FindFiles(string fileName, out IList<DokanNet.FileInformation> files, IDokanFileInfoWrapper info);
        ...
        NtStatus FindFilesWithPattern(
            ...
            out IList<DokanNet.FileInformation> files,
            IDokanFileInfoWrapper info);
        ...
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        NtStatus SetFileAttributes(string fileName, FileAttributes attributes, IDokanFileInfoWrapper info);
        ...
        ///
        /// DeleteFile will also be called with <see cref="IDokanFileInfoWrapper.DeleteOnClose"/> set to <c>false</c>
        ...
        /// <see cref="IDokanFileInfoWrapper.DeleteOnClose"/> set to <c>true</c> and only then you have to actually
        ...
        /// <seealso cref="DeleteDirectory"/>
        /// <seealso cref="Cleanup"/>
        NtStatus DeleteFile(string fileName, IDokanFileInfoWrapper info);
        ...
        /// <seealso cref="DeleteFile"/>
        /// <seealso cref="Cleanup"/>
        NtStatus DeleteDirectory(string fileName, IDokanFileInfoWrapper info);
        ...
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        NtStatus MoveFile(string oldName, string newName, bool replace, IDokanFileInfoWrapper info);
        ...
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        NtStatus SetEndOfFile(string fileName, long length, IDokanFileInfoWrapper info);
        ...
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        NtStatus SetAllocationSize(string fileName, long length, IDokanFileInfoWrapper info);
        ...
        NtStatus LockFile(string fileName, long offset, long length, IDokanFileInfoWrapper info);
        ...
        NtStatus UnlockFile(string fileName, long offset, long length, IDokanFileInfoWrapper info);
        ...
        /// </summary>
        /// <remarks>
        /// Neither GetDiskFreeSpace nor <see cref="GetVolumeInformation"/> save the <see cref="IDokanFileInfoWrapper.Context"/>.
        ...
        /// </summary>
        /// <remarks>
        /// Neither GetVolumeInformation nor <see cref="GetDiskFreeSpace"/> save the <see cref="IDokanFileInfoWrapper.Context"/>.
        /// Before these methods are called, <see cref="CreateFile"/> may not be called. (ditto <see cref="CloseFile"/> and <see cref="Cleanup"/>).
        /// 
        ...
        /// <returns><see cref="NtStatus"/> or <see cref="DokanResult"/> appropriate to the request result.</returns>
        /// <see cref="Unmounted"/>
        NtStatus Mounted(IDokanFileInfoWrapper info);
        ...
        NtStatus Unmounted(IDokanFileInfoWrapper info);
        ...
        /// 
        /// <param name="fileName">File path requested by the Kernel on the FileSystem.</param>
        /// <param name="streams">List of <see cref="DokanNet.FileInformation"/> for each streams present on the file.</param>
        /// <param name="info">An <see cref="IDokanFileInfoWrapper"/> with information about the file or directory.</param>
        ...
        NtStatus FindStreams(string fileName, out IList<DokanNet.FileInformation> streams, IDokanFileInfoWrapper info);
    }
}
